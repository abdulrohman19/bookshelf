...
inputBookIsComplete.addEventListener('change', function () {
    ...
    if (inputBookIsComplete.checked) {
        bookSubmit.innerText = 'Finished reading'
    } else {
        bookSubmit.innerText = 'Not finished reading yet'
    }
})
...
/**
 * This function is used to check whether localStorage is supported by the browser or not
 *
 * @returns boolean
 */
...
/**
 * This function is used to save data to localStorage
 * based on a previously determined KEY.
 */
function saveData() {
    if (isStorageExist()) {
...
/**
 * This function is used to load data from localStorage
 *  And enter the parsed data into variables {@see books}
 */
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    submitForm.addEventListener('submit', function (event) {
        ...
        if (typeof Storage !== undefined) {
            ...
            toast.innerHTML = `Buku  <b>&nbsp;${newBook.title}&nbsp;</b>  Added successfully`;
    ...
    for (const bookItem of books) {
        if (bookItem.title.toLowerCase().includes(searchTitle.value.toLowerCase())) {
            if (bookItem.isCompleted === true) {
                ...
                bookStatus.innerText = 'Finished reading';
...
function removeBook(bookId) {
    ...
    description.innerText = 'Are you sure you want to delete this book?';

    const label = document.createElement('label');
    label.innerText = 'If you are sure, click the "Delete" button';
    ...
    btnDelete.addEventListener('click', function (event) {
        ...
        toast.style.color = '#fff';
        toast.innerText = 'The book has been successfully deleted';
        document.body.append(toast);
